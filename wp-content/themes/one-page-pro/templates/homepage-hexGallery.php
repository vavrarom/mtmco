			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<h2 class="main_head animated fade_in_up"><?php echo wp_kses_post( onepage_get_option( 'onepage_portfolio_main_heading', __( 'Our Portfolio Section', 'one-page' ) ) ); ?></h2>
						<hr class="gallery_sep animated fade_in_up">
						<p class="main_desc animated fade_in_up"><?php echo wp_kses_post( onepage_get_option( 'onepage_portfolio_sub_heading', __( 'This is Photoshop\'s version of Lorem Ipsum. Proin gravida', 'one-page' ) ) ); ?></p>
					</div>
				</div>
				<div class="row">
