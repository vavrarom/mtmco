...
$sliders['slider1'] = array(
	...
	'onepage_slider_overlay' => onepage_get_option( 'onepage_slider_overlay_1','rgba(29, 105, 165, 0.82)' ),
);
$sliders['slider2'] = array(
	...
	'onepage_slider_overlay' => onepage_get_option( 'onepage_slider_overlay_2','rgba(29, 105, 165, 0.82)' ),
);
$sliders['slider3'] = array(
	...
	'onepage_slider_overlay' => onepage_get_option( 'onepage_slider_overlay_3','rgba(29, 105, 165, 0.82)' ),
);
$sliders['slider4'] = array(
	...
	'onepage_slider_overlay' => onepage_get_option( 'onepage_slider_overlay_4','rgba(29, 105, 165, 0.82)' ),
);
$sliders['slider5'] = array(
	...
	'onepage_slider_overlay' => onepage_get_option( 'onepage_slider_overlay_5','rgba(29, 105, 165, 0.82)' ),
);
							...
							<div class="sl-slide-inner">
								...
								<div class="slider_caption_wrapper">
									<div class="slider_caption">
										<h2><?php echo wp_kses_post( $slider['onepage_slider_heading'] ); ?></h2>
                                                                                 <?php if(isset($slider['onepage_slider_heading']) && $slider['onepage_slider_heading'] != '' && isset($slider['onepage_slider_subheading']) && $slider['onepage_slider_subheading'] != ''){ ?>
										<div class="slider_sep"></div>
                                                                                 <?php } ?>
										<p><?php echo wp_kses_post( $slider['onepage_slider_subheading'] ); ?></p>
                                                                                <?php if(isset($slider['onepage_slider_button_text']) && $slider['onepage_slider_button_text'] != ''){ ?>
                                                                                <a class="slider_button" href="<?php echo esc_url( $slider['onepage_slider_button_link'] ); ?>"><?php echo wp_kses_post( $slider['onepage_slider_button_text'] ); ?></a><?php } ?>
									</div>
								</div>
