        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="main_head animated fade_in_up"><?php echo wp_kses_post(onepage_get_option('onepage_contact_main_heading', __('Contact Section', 'one-page'))); ?></h2>
                    <hr class="team_sep animated fade_in_up" <?php echo "style='background-color:" . onepage_get_option('onepage_contact_hr_color', '#beb9f0') . "'"; ?>>
                    <p class="main_desc animated fade_in_up"><?php echo wp_kses_post(onepage_get_option('onepage_contact_sub_heading', __('Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'one-page'))); ?></p>
                </div>
            </div>
            <div class="row">
                <div class="contact_wrapper">
                    <div class="col-md-5">
                        <div class="contact_content">
                            ...
                            <form class="contactform" action="#" method="post">
                                ...
                                <?php
                                echo get_option('onepage_custom_editor');
                                ?>
                                <div class="clear"></div>
                    ...
                    <div class="col-md-7">
                        <div style="width: 100%; overflow:hidden; animation-delay: .6s;" class="contact_map animated fade_right"> <?php echo onepage_sanitize_html(onepage_get_option('onepage_contact_map_iframe', '<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14667.209208772476!2d77.43003554999999!3d23.21387435!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0000000000000000%3A0x5bcb829200a9052d!2s10+no.+Market!5e0!3m2!1sen!2sin!4v1455254567580" width="100%" height="320" frameborder="0" style="border:0"></iframe>')); ?><br /></div>
                    </div>
                </div>
            </div>
        </div>
