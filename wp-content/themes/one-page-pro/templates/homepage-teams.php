        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="main_head"><?php echo wp_kses_post(onepage_get_option('onepage_team_main_heading', __('Team Section', 'one-page'))); ?></h2>
                    <hr class="team_sep">
                    <p class="main_desc"><?php echo wp_kses_post(onepage_get_option('onepage_team_sub_heading', __('Lorem Ipsum is simply dummy text of the printing and typesetting industry.', 'one-page'))); ?></p>
                </div>
            </div>
            <div class="row">
                <div class="team_wrapper">
                    <div class="col-md-3 col-sm-6">
                        <div class="team_item animated bounce" style="animation-delay: .3s">
                            ...
                            <h4><?php echo wp_kses_post(onepage_get_option('onepage_member1_name', __('Team Member A', 'one-page'))); ?></h4>
                            <span><?php echo wp_kses_post(onepage_get_option('onepage_member1_designation', __('Creative Director', 'one-page'))); ?></span>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team_item animated bounce" style="animation-delay: .6s">
                            ...
                            <h4><?php echo wp_kses_post(onepage_get_option('onepage_member2_name', __('Team Member B', 'one-page'))); ?></h4>
                            <span <?php echo "style='color:" . onepage_get_option('onepage_team_member_designation_text_color', '#235e11') . "'"; ?>><?php echo wp_kses_post(onepage_get_option('onepage_member2_designation', __('Creative Director', 'one-page'))); ?></span>
                            <ul class="team_social" <?php echo "style='background-color:" . onepage_get_option('onepage_team_social_icons_bg_color', '#2bb6b6') . "'"; ?>>
                                <li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team_item animated bounce" style="animation-delay: .9s">
                            ...
                            <h4><?php echo wp_kses_post(onepage_get_option('onepage_member3_name', __('Team Member C', 'one-page'))); ?></h4>
                            <span <?php echo "style='color:" . onepage_get_option('onepage_team_member_designation_text_color', '#235e11') . "'"; ?>><?php echo wp_kses_post(onepage_get_option('onepage_member3_designation', __('Creative Director', 'one-page'))); ?></span>
                            <ul class="team_social" <?php echo "style='background-color:" . onepage_get_option('onepage_team_social_icons_bg_color', '#2bb6b6') . "'"; ?>>
                                <li>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="team_item animated bounce" style="animation-delay: 1.2s">
                            ...
                            <h4><?php echo wp_kses_post(onepage_get_option('onepage_member4_name', __('Team Member D', 'one-page'))); ?></h4>
                            <span <?php echo "style='color:" . onepage_get_option('onepage_team_member_designation_text_color', '#235e11') . "'"; ?>><?php echo wp_kses_post(onepage_get_option('onepage_member4_designation', __('Creative Director', 'one-page'))); ?></span>
                            <ul class="team_social" <?php echo "style='background-color:" . onepage_get_option('onepage_team_social_icons_bg_color', '#2bb6b6') . "'"; ?>>
                                <li>
                    ...
                    <?php
                    if (onepage_get_option('onepage_team_members_shortcode') != ''):
                        echo do_shortcode(onepage_get_option('onepage_team_members_shortcode'));
                    endif;
                    ?>
                </div>
            </div>
