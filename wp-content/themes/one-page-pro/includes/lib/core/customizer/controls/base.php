		...
		*/
		public function render_history_actions() {
			...
			<div class="customize-control-history">
				...
				<a href="#" class="customize-control-default fa fa-refresh" title="<?php _e( 'Reset (cleans the field returning it to original default state)', 'one-page' ) ?>" data-default="<?php echo esc_attr( $this->default ); ?>"></a>
			</div>
			<?php
		}
