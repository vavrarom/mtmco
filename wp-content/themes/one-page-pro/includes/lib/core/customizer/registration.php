	...
	public function init() {
		...
		$wp_customize->add_panel(
			'widgets', array(
				...
				'description' => Layers_Customizer::get_instance()->render_builder_page_dropdown() . __('Use this area to add widgets to your page, use the (Layers) widgets for the Body section.' , 'one-page' ),
			)
		);
	}
