...
class Layers_Customizer_Config {
    ...
    private function panels() {
        ...
        $layers_customizer_panels = array(
            'site-settings' => array(
                'title' => __('Site Settings', 'one-page'),
                'description' => __('Control your content\'s default layout.', 'one-page'), // @TODO Put a helper here
                'priority' => 40
            ),
            'header' => array(
                'title' => __('Header', 'one-page'),
                'description' => __('Control your header\'s logo, layout, colors and font.', 'one-page'), // @TODO Put a helper here
                'priority' => 60
            ),
            'blog-archive-single' => array(
                'title' => __('Blog', 'one-page'),
                'description' => __('Control your sites\'s sidebars and blog layout.', 'one-page'), // @TODO Put a helper here
                'priority' => 70
            ),
            'footer' => array(
                'title' => __('Footer', 'one-page'),
                'description' => __('Control your footer\'s custom text, widget areas and layout.', 'one-page'), // @TODO Put a helper here
                'priority' => 80
            ),
            'woocommerce' => array(
                'title' => __('WooCommerce', 'one-page'),
                'priority' => 100
            ),
        );
...
//			'title' =>__( 'Sidebars' , 'one-page' ),
//			'panel' => 'woocommerce',
//		);
//		$layers_customizer_sections['body-customization' ] = array(
//			'title' =>__( 'Customization' , 'one-page' ),
//			'panel' => 'body',
//		);
    ...
    private function controls() {
        ...
        $customizer_dir = '/includes/lib/core/customizer/';
...
//			'typekit-id' => array(
//				'type' => 'layers-text',
//				'label'    => __( 'Typekit ID' , 'one-page' ),
//				'description' => sprintf( __( 'For more information on obtaining your Typekit ID, see <a href="%s" target="_blank">follow this link</a>.', 'one-page' ), 'http://help.typekit.com/customer/portal/articles/6780' ),
//			),
//			'body-fonts' => array(
//				'type' => 'layers-font',
//				'label'    => __( 'Body' , 'one-page' ),
//				'selectors' => 'body',
//				'choices' => layers_get_google_font_options(),
//			),
//			'heading-fonts' => array(
//				'type' => 'layers-font',
//				'label'    => __( 'Headings' , 'one-page' ),
//				'selectors' => 'h1,h2,h3,h4,h5,h6, .heading',
//				'choices' => layers_get_google_font_options(),
//			),
//			'form-fonts' => array(
//				'type' => 'layers-font',
//				'label'    => __( 'Buttons' , 'one-page' ),
...
//				'heading_divider' => __( 'Header Width' , 'one-page' ),
...
//				'type'     => 'layers-select-icons',
//				'heading_divider' => __( 'Header Arrangement' , 'one-page' ),
//				'default' => 'header-logo-left',
//				'choices' => array(
//					'header-logo-left' => __( 'Logo Left' , 'one-page' ),
//					'header-logo-right' => __( 'Logo Right' , 'one-page' ),
//					'header-logo-center-top' => __( 'Logo Center Top' , 'one-page' ),
//					'header-logo-top' => __( 'Logo Top' , 'one-page' ),
//					'header-logo-center' => __( 'Logo Center' , 'one-page' ),
//				),
//			),
//			'header-position-heading' => array(
//				'type'  => 'layers-heading',
//				'heading_divider' => __( 'Sticky Header' , 'one-page' ),
//			),
//			'header-sticky' => array(
//				'type'		=> 'layers-checkbox',
//				'label'		=> __( 'Sticky' , 'one-page' ),
//				'class'		=> 'layers-pull-top layers-pull-bottom',
//				'default'	=> FALSE,
//			),
//			'header-overlay' => array(
//				'type'     => 'layers-checkbox',
//				'label'    => __( 'Transparent Overlay' , 'one-page' ),
//				'default'	=> FALSE,
//				/*
//				'linked' => array(
...
//				'class' => 'layers-upsell-tag',
//				'label'    => __( 'Upgrade to Layers Pro' , 'one-page' ),
//				'description' => __( 'Want more control over your Header Layout? <a target="_blank" href="http://codecanyon.net/item/layers-pro-extended-customization-for-layers/11225042?ref=obox&utm_source=layers%20theme&utm_medium=link&utm_campaign=Layers%20Pro%20Upsell&utm_content=Site%20Settings%20Header%20Layout">Purchase Layers Pro</a> to unlock the full power of Layers!' , 'one-page' ),
//			),
//		);
...
//				'type'  => 'layers-heading',
//				'label'    => __( 'Single Post Sidebar(s)' , 'one-page' ),
//				'description' => __( 'This option affects your single post pages.' , 'one-page' ),
//			),
//			'single-left-sidebar' => array(
//				'type'      => 'layers-checkbox',
//				'label'     => __( 'Display Left Sidebar' , 'one-page' ),
//				'default'   => FALSE,
//			),
//			'single-right-sidebar' => array(
//				'type'      => 'layers-checkbox',
//				'label'     => __( 'Display Right Sidebar' , 'one-page' ),
//				'default'   => TRUE,
//			),
...
//				'type'  => 'layers-heading',
//				'label'    => __( 'Archive Sidebar(s)' , 'one-page' ),
//				'description' => __( 'This option affects your category, tag, author and search pages.' , 'one-page' ),
//			),
...
//				'type'  => 'layers-heading',
//				'label'    => __( 'Site Wide Colors' , 'one-page' ),
//				'description' => __( 'These options allow you to change the key colors of your Layers website.' , 'one-page' ),
//			),
//			'header-background-color' => array(
//				'label' => '',
//				'subtitle'		=> __( 'Header Color' , 'one-page' ),
//				'description' => __( 'This affects the background colors of your site header and page titles.', 'one-page' ),
//				'type'		=> 'layers-color',
//				'default'	=> '#F3F3F3',
//			),
//			'site-accent-color' => array(
//				'label' => '',
//				'subtitle' => __( 'Site Accent Color', 'one-page' ),
//				'description' => __( 'Choose a color for your buttons and links.', 'one-page' ),
//				'type' => 'layers-color',
//				'default' => FALSE,
//			),
//			'footer-background-color' => array(
//				'label' => '',
//				'subtitle' => __( 'Footer Color' , 'one-page' ),
//				'description' => __( 'This affects the background color of your site footer.', 'one-page' ),
//				'type' => 'layers-color',
//				'default' => '#F3F3F3',
//			),
...
//				'class' => 'layers-upsell-tag',
//				'label'    => __( 'Upgrade to Layers Pro' , 'one-page' ),
//				'description' => __( 'Want more color customzation? <a target="_blank" href="http://codecanyon.net/item/layers-pro-extended-customization-for-layers/11225042?ref=obox&utm_source=layers%20theme&utm_medium=link&utm_campaign=Layers%20Pro%20Upsell&utm_content=Footer%20Layout">Purchase Layers Pro</a> and get the full box of crayons!' , 'one-page' ),
//			),
//		);
//
...
//				'type'     => 'layers-checkbox',
//				'label'    => __( 'Dev Switches Active' , 'one-page' ),
//				'description' => __( 'Unckecking this will immediately remove this panel. To switch it back on you will need to add #layers-develop to your url.' , 'one-page' ),
//				'default' => '',
//			),
//			'dev-switch-customizer-state-record' => array(
//				'type'     => 'layers-checkbox',
//				'label'    => __( 'Remember State in Customizer' , 'one-page' ),
//				'description' => __( 'This feature will add #hash values to the customizer URL so that when the page is refreshed the customizer will go back to it\'s same position.' , 'one-page' ),
//				'default' => '',
//			),
//			'dev-switch-widget-field-names' => array(
//				'type'     => 'layers-checkbox',
//				'label'    => __( "Display Widget Input 'name' Attributes", 'one-page' ),
//				'description' => __( 'This is used in preparation of a new Widget so developer can quickly see all the possible fields in a Widget and make sure to set defaults for them.', 'one-page' ),
//				'default' => '',
//			),
//		);
//
...
//				'type'     => 'layers-text',
//				'label'    => __( 'Google Analytics ID' , 'one-page' ),
//				'description' => __( 'Enter in your Google Analytics ID to enable website traffic reporting. eg. "UA-xxxxxx-xx' , 'one-page' ),
//				'default' => '',
//			),
//			'header-custom-scripts' => array(
//				'type'     => 'layers-code',
//				'label'    => __( 'Custom Scripts' , 'one-page' ),
//				'description' => __( 'Enter in any custom script to include in your site\'s header. Be sure to use double quotes for strings.' , 'one-page' ),
//				'default' => '',
//			),
//		);
//
...
//			'footer-width' => array(
//				'type'     => 'layers-select-icons',
//				'heading_divider' => __( 'Footer Width' , 'one-page' ),
//				'default' => 'layout-boxed',
//				'choices' => array(
//					'layout-boxed' => __( 'Boxed' , 'one-page' ),
//					'layout-fullwidth' => __( 'Full Width' , 'one-page' ),
...
//				'type'     => 'layers-select',
//				'heading_divider'    => __( 'Widget Areas' , 'one-page' ),
//				'description' => __( 'Choose how many widget areas apear in the footer. Go here to <a class="customizer-link" href="#accordion-panel-widgets">customize footer widgets</a>.', 'one-page' ),
//				'default' => 4,
...
//				'type'     => 'layers-text',
//				'label'    => __( 'Copyright Text' , 'one-page' ),
//				'default' => ' Made at the tip of Africa. &copy;',
//				'sanitize_callback' => FALSE
//			),
//			'show-layers-badge' => array(
//				'label' => __( 'Support Layers' , 'one-page' ),
//				'description' => __( 'Support Layers by displaying the Layers badge on your site.', 'one-page' ),
//				'type' => 'layers-checkbox',
//				'default' => true
//			),
...
//				'class' => 'layers-upsell-tag',
//				'label'    => __( 'Upgrade to Layers Pro' , 'one-page' ),
//				'description' => __( 'Want more control over your Footer Layout? <a target="_blank" href="http://codecanyon.net/item/layers-pro-extended-customization-for-layers/11225042?ref=obox&utm_source=layers%20theme&utm_medium=link&utm_campaign=Layers%20Pro%20Upsell&utm_content=Site%20Settings%20Footer%20Layout">Purchase Layers Pro</a> to unlock the full power of Layers!' , 'one-page' ),
//			),
//		);
//
...
//				'type'     => 'layers-code',
//				'label'    => __( 'Custom Scripts' , 'one-page' ),
//				'description' => __( 'Enter in any custom script to include in your site\'s footer. Be sure to use double quotes for strings.' , 'one-page' ),
//				'default' => '',
//			),
//		);
//
...
//				'type'  => 'layers-heading',
//				'class' => 'layers-upsell-tag',
//				'label'    => __( 'Upgrade to DevKit' , 'one-page' ),
//				'description' => __( 'Want the best CSS customization interface? <a target="_blank" href="http://bit.ly/layers-devkit">Purchase DevKit</a> and save bundles of time!' , 'one-page' ),
//			),
//		);
...
//					'type'  => 'layers-heading',
//					'label'    => __( 'Single Product Sidebar(s)' , 'one-page' ),
//					'description' => __( 'This option affects your single product pages.' , 'one-page' ),
//				),
...
//					'type'  => 'layers-heading',
//					'label'    => __( 'Product List Sidebar(s)' , 'one-page' ),
//					'description' => __( 'This option affects your shop page, product category and product tag pages.' , 'one-page' ),
//				),
