	...
	*/
	...
	function layers_init_editor( $id ){
		...
		var $editor_data = {
			...
			inlineMode: false,
			initOnClick: false,
//			imageButtons: [ 'removeImage','displayImage' ],
			imageButtons: ['align',"floatImageLeft","floatImageNone","floatImageRight","linkImage","removeImage"],
//                        imageButtons: ['imageReplace', 'imageAlign', 'imageRemove'],
